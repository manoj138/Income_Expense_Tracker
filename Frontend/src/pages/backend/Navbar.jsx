    ...
    <header className="sticky top-0 z-30 flex w-full items-center justify-between gap-3 border-b border-slate-200/80 bg-white/72 px-4 py-3 shadow-[0_12px_35px_-30px_rgba(15,23,42,0.35)] backdrop-blur-xl transition-all duration-500 dark:border-slate-800 dark:bg-slate-900/80 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="relative" ref={notificationRef}>
          ...
          {showNotifications && (
            <div className="absolute -right-10 sm:right-0 top-full z-[60] mt-4 w-[calc(100vw-2rem)] max-w-[360px] rounded-[2rem] border border-slate-100 bg-white/95 p-3 shadow-[0_20px_50px_rgba(0,0,0,0.15)] backdrop-blur-xl animate-in fade-in zoom-in-95 duration-200 dark:border-slate-800 dark:bg-slate-900/95 sm:w-[360px] sm:left-auto">
              {renderNotifications()}
            </div>
          )}
        </div>
