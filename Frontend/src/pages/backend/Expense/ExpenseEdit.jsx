  ...
  return (
    <div className="flex flex-col items-center w-full relative z-10">
          ...
          <div className="w-full max-w-2xl flex justify-between items-end mb-6 sm:mb-10">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 text-rose-600 mb-1 sm:mb-2">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.4em]">Modification Protocol</span>
              </div>
              <h1 className="text-2xl sm:text-4xl font-[1000] text-slate-900 dark:text-white tracking-tighter truncate">
                Update <span className="italic text-rose-600">Expense</span>
              </h1>
            </div>
          ...
          <div className="mt-10 text-center opacity-30">
             <p className="text-[9px] font-black uppercase tracking-[0.6em] text-slate-500 italic">Capital Ledger Authentication System v2.0</p>
          </div>
    </div>
  );
};
